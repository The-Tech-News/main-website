    ...
    <body>
        ...
        <main class="container py-4">
            ...
            <%
                ...
                HashMap<Integer, Category> categories = (HashMap<Integer, Category>) request.getAttribute("categories");
            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="text-muted small">
                        Author: <%= users.get(p.getUserId())%> - Category: <%= categories.get(p.getCategoryId()).getName()%>
                        <% if (p.isHidden()) { %>
                    ...
                    <div class="mt-3">
                        <a class="btn btn-primary btn-sm" href="<%= request.getContextPath()%>/post?id=<%= p.getId()%>">
                            Read
                        </a>
                    </div>
                </div>
