 ...
 * 
 * Chức năng:
 * - Hiển thị quảng cáo theo postId (/ads)
 * - Quản lý quảng cáo cho admin (/admin/ads)
 * - CRUD Ads: List, Create, Edit, Delete
 * 
 * Mapping URL:
 * /ads        -> hiển thị quảng cáo theo bài viết
 * /admin/ads  -> trang quản lý quảng cáo của admin
 * 
 * @author PC
 */
...
public class AdsServlet extends HttpServlet {
     ...
     * - Hiển thị quảng cáo theo postId
     * - Hiển thị danh sách ads
     * - Mở form create
     * - Mở form edit
     * - Delete ads
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getServletPath().equals("/ads")) {
            ...
            List<Ads> list = adsDAO.getAdsByPostId(postId);

            // Gửi danh sách ads sang JSP
            request.setAttribute("adsList", list);

            // Forward sang trang hiển thị quảng cáo
